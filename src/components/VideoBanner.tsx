  ...
  return (
    <section id="video" ref={ref} className="relative h-[90svh] overflow-hidden">
      <motion.div style={{ scale, y }} className="absolute inset-0">
        <ClipReveal from="up" duration={1.6} className="h-full w-full">
          <img src={hero} alt="Cinematic Sidoarjo" className="h-full w-full object-cover" />
        </ClipReveal>
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-background/60 via-background/20 to-background" />
      </motion.div>
