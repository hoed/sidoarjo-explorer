...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "BPPD Sidoarjo — Discover the Hidden Wonders of the Delta" },
      { property: "og:description", content: "An immersive tourism experience by Badan Promosi Pariwisata Daerah Sidoarjo. Explore nature, heritage, culture, culinary and adventure in the heart of East Java." },
